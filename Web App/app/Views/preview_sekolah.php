      ...
      <div class="container">
        <div class="row">
          ...
          <div data-aos="fade-up" class="alert alert-success alert-dismissible fade show" role="alert">
            ...
            <h2 data-aos="fade-up" data-aos-delay="200">Profil Sekolah</h2>
            </div>

          <div class="col-lg-4 col-md-6 col-12" data-aos="fade-up" data-aos-delay="400">
            <div class="class-thumb">
              <div class="class-info">
                <img src="<?php echo base_url('images/School.jpg');?>" class="img-fluid" alt="foto1" />
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-6 col-md-6 col-12" data-aos="fade-up" data-aos-delay="400">
            <div class="class-thumb">
              <p class="mt-3">Nama Sekolah<span style="padding-left:55px;">:</span> <?= $dataPreview['nama_sekolah'] ?></p>
              <p class="mt-3">Tingkat<span style="padding-left:115px;">:</span> <?= $dataPreview['tingkat'] ?></p>
              <p class="mt-3">Provinsi<span style="padding-left:110px;">:</span> <?= $dataPreview['provinsi'] ?></p>
              <p class="mt-3">Kabupaten<span style="padding-left:85px;">:</span> <?= $dataPreview['kabupaten'] ?></p>
              <p class="mt-3">Alamat<span style="padding-left:117px;">:</span> <?= $dataPreview['alamat'] ?></p>
              <p class="mt-3">Email Sekolah<span style="padding-left:60px;">:</span> <?= $dataPreview['email'] ?></p>
              <p class="mt-3">Kontak Pendamping<span style="padding-left:10px;">:</span> <?= $dataPreview['kontak_pendamping'] ?></p>
              <p class="mt-3">Kontak Sekolah<span style="padding-left:50px;">:</span> <?= $dataPreview['kontak_sekolah'] ?></p>
            </div>
          </div>
