      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 col-12 text-center mb-5 mt-4">
            <h2 data-aos="fade-up" data-aos-delay="200">Tingkat Pendidikan</h2>
          </div>

          <div class="col-lg-4 col-md-6 col-12" data-aos="fade-up" data-aos-delay="400">
            <div class="class-thumb">
              <div class="class-info">
                <h3 class="mb-1 text-center">SD</h3>
                <a href="<?= base_url('register/sd') ?>">
                <button type="submit" class="form-control" id="submit-button" name="submit">Pendaftaran SD</button>
                </a>
              </div>
            </div>
          </div>
          ...
          <div class="mt-5 mt-lg-0 mt-md-0 col-lg-4 col-md-6 col-12" data-aos="fade-up" data-aos-delay="500">
            <div class="class-thumb">
              <div class="class-info">
                <h3 class="mb-1 text-center">SMP</h3>
                <a href="<?= base_url('register/smp') ?>">
                <button type="submit" class="form-control" id="submit-button" name="submit">Pendaftaran SMP</button>
                </a>
              </div>
            </div>
          </div>
          ...
          <div class="mt-5 mt-lg-0 col-lg-4 col-md-6 col-12" data-aos="fade-up" data-aos-delay="600">
            <div class="class-thumb">
              <div class="class-info">
                <h3 class="mb-1 text-center">SMA</h3>
                <a href="<?= base_url('register/sma') ?>">
                <button type="submit" class="form-control" id="submit-button" name="submit">Pendaftaran SMA</button>
                </a>
              </div>
            </div>
          </div>
