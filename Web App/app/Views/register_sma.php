    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12 col-12 text-center mb-5 mt-4">
          <h2 data-aos="fade-up" data-aos-delay="200">Pendaftaran Peserta SMA</h2>
        </div>
        ...
        <?php if (!empty(session()->getFlashdata('error'))) : ?>
            ...
            <?php endif; ?>
            <form action="<?= base_url(); ?>/register/sma/process" method="post" class="contact-form webform" data-aos="fade-up" role="form" enctype="multipart/form-data">
